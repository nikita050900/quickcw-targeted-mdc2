...
################################################################################
#@profile
def QuickCW(chain_params, psrs, noise_json=None, use_legacy_equad=True, include_ecorr=False, amplitude_prior='detection', gwb_gamma_prior=None, psr_distance_file=None, backend_selection=False):
    ...
    log10_Agw = parameter.Uniform(-18,-11)('gwb_log10_A')
    ...
    m_max = 10  # This is calculated and changed for a target. Production chains for Runs A to D used 11; posteriors sit near 9.8, far below either bound.
