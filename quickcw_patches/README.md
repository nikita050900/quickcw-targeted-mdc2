...
and 3.7 nHz gives 7.03. The upper bound is 10, matching Table 2 of the paper,
in `QuickCW_G2D2.py` and `QuickCW_G2D2_fixed.py`, and 11 in `QuickCW_G2D1.py`
and `QuickCW_G2D2_allsky.py`. The upper limits reported in Section 5.3 lie
