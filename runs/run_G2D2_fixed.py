#!/usr/bin/env python
"""Run F of Table 3: G2D2 with fGW fixed to the EM value.
...
import QuickCW.QuickCW_G2D2_fixed as QuickCW
...
parser = argparse.ArgumentParser(description="Run F of Table 3: G2D2, fGW fixed to the EM value.")
parser.add_argument(
    "--save_filename",
    type=str,
