#!/usr/bin/env python
"""Run G of Table 3: G2D2 with fGW fixed and the sky position left free.
...
import QuickCW.QuickCW_G2D2_allsky as QuickCW
...
parser = argparse.ArgumentParser(description="Run G of Table 3: G2D2, fGW fixed, sky position free.")
parser.add_argument(
    "--save_filename",
    type=str,
    default="redo.h5",
