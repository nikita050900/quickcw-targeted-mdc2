#!/bin/bash
# Run C of Table 3: G2D1, broad fGW, upper limit prior
#
# SLURM template. Set the partition and any account string your site needs,
# then submit with  sbatch submit_C.sh
#SBATCH --job-name=G2D1_broad_UL_4core
#SBATCH --output=G2D1_broad_UL_4core_%j.out
...
/usr/bin/time -v python "$(dirname "$0")/run_G2D1_broad.py" \
    --save_filename G2D1_broad_UL_4core.h5 \
    --amplitude_prior UL
