#!/usr/bin/env python
"""Runs B and D of Table 3: G2D1 with fGW fixed to the EM value.
...
import QuickCW.QuickCW_G2D1 as QuickCW
...
data_pkl = os.path.join(DATA_DIR, "psr_objects/G2D1_IPTA_MDC2_all_pulsars.pkl")
...
noisefile = os.path.join(DATA_DIR, "noise_files/fit_psr_noise_dataset1.json")
...
parser = argparse.ArgumentParser(description="Runs B and D of Table 3: G2D1, fGW fixed to the EM value.")
parser.add_argument(
    "--save_filename",
    type=str,
    default="redo.h5",
